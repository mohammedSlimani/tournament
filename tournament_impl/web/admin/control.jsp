<%-- 
    Document   : control
    Created on : 29-Jan-2019, 16:41:53
    Author     : rick
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="${pageContext.request.contextPath}/admincontrol">Control Room</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="${pageContext.request.contextPath}/adminmain">Admin Room</a>
                        </li>
                    </ul>
                </div>
            </div>
